...
export function SiteFooter({ settings }: { settings: ChurchSettings }) {
  ...
  return (
    <footer className="px-6 pb-8 pt-12">
      <div className="mx-auto flex max-w-[1760px] flex-wrap items-start justify-between gap-6">
        <div>
      ...
      <p className="mx-auto mt-6 max-w-[1760px] text-center text-xs text-ink-soft">
